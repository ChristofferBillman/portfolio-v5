 ...
 *	</TransitionLifecycle>
 */
export const TransitionLifecycle = forwardRef(({ children, transition, willRender, style, id, className }: Props, ref: React.ForwardedRef<HTMLDivElement>): JSX.Element => {
	...
	return (
		<div style={{...getCurrentStyle(), ...style}} id={id} className={className} ref={ref}>
